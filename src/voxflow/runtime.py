...
class DictationRunner:
    ...
    def run_once(
        ...
        return self._process_audio(audio_path, target_window=target_window, on_recorded=on_recorded)
    ...
    def run_until_stop(
        ...
        audio_path = self.recorder.record_until_stop(stop_event)
        return self._process_audio(audio_path, target_window=target_window, on_recorded=on_recorded)
    ...
    def _process_audio(
        ...
        *,
        ...
        on_recorded: Callable[[Path], None] | None,
    ) -> tuple[TranscriptionResult, list[EditAction]]:
        try:
            if on_recorded:
